...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Nuovo_flight_simulator p_Nuovo_flight_simulator;
        ...
        public static SteamVR_Input_ActionSet_Nuovo_flight_simulator Nuovo_flight_simulator
        {
            get
            {
                return SteamVR_Actions.p_Nuovo_flight_simulator.GetCopy<SteamVR_Input_ActionSet_Nuovo_flight_simulator>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Nuovo_flight_simulator = ((SteamVR_Input_ActionSet_Nuovo_flight_simulator)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Nuovo_flight_simulator>("/actions/Nuovo_flight_simulator")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Nuovo_flight_simulator};
        }
    }
}
